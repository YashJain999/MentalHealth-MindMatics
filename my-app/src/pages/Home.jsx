...
=======
        <div className="relative min-h-screen bg-cover bg-fixed bg-center" style={{ backgroundImage: `url(${bgimage})` }}>
                ...
                <div className="pt-10 flex justify-between items-center">
                    ...
                    <div className="flex space-x-4 ">
                        <RouterLink to="/logout">
                            <button className="px-4 py-2 mt-2.5 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition duration-300">
                                Log Out
                            </button>
                        </RouterLink>
                    </div>
